...
import { getExpensesTransactions, addExpenseTransaction} from "../../redux/transactions-operations";
...
const ExpensesPage = () => {
  ...
  let transaction = { date: "2020-12-31", description: 'Lorem Ipsum', category: "Алкоголь", amount: 15.7777777 }
    // болванка, удалить в процессе
  return (
    <>
      <button type="button" onClick={()=>{ dispatch(getExpensesTransactions())}}>GET EXPENSES TRANSACTIONS</button>
